...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#sub").click(function () {
            if(/^\w{6,10}$/.test($("[name='passWord']").val())&&flag&&$("[name='power']").val()!=-1&& $("#userName").val()!=""){
                $.ajax({
                    url:"${pageContext.request.contextPath}/admin.do/add",
                    data:{
                        userName:$("#userName").val(),
                            ...
                            <div class="content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>用户名</label>
                                                <input type="text" class="form-control" id="userName" placeholder="真实姓名" name="userName" >
                                                <span id="recMsg"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>密码</label>
                                                <input type="password" class="form-control" placeholder="不能为汉字" name="passWord" >
                                            </div>
                                        </div>
                                    </div>

                                    <button  class="btn btn-info btn-fill pull-right" id="sub">添加</button>

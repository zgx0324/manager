        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <form action="${pageContext.request.contextPath}/product.do/add"
                                ...
                                <div class="content">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <p>上传商品缩略图</p>
                                            <img id='img0' src='' width='106' alt=''><span id='button0'></span>
                                    ...
                                    <div>
                                        <div style="float: left;width: 200px;margin-left: 20px">
                                            <label>库存</label>
                                            <input type="number" name="stock" class="form-control" style="width: 100px"  min="0" step="1" placeholder="/件">
                                        </div>
                                        <div style="float: left;width: 200px;margin-left: 20px">
                                            <label>市场价 ￥</label>
                                            <input type="text" name="shopPrice" class="form-control" style="width: 100px" placeholder="00.0">
                                        </div>
                                        <div style="float: left;width: 200px;margin-left: 20px">
                                            <label>促销价 ￥</label>
                                            <input type="text" name="marketPrice" class="form-control" style="width: 100px" placeholder="00.0">
                                        </div>
                                    </div>
                                    ...
                                    <button type="button" id="ssb"
                                            class="btn btn-info btn-fill pull-right">上传</button>
